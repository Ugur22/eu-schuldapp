	  ...
	  <nb-card>
		<nb-card-item>
		  ...
		  >
			...
			<item label="1.1_1.2_Akte_van_Cessie" value="3" />
			<item label="1.3_MachtigingSysteem" value="4" />
			<item label="1.4_Machtigingsformulier_auto_Incasso" value="5" />
			<item label="1.5_Schuldhulp_contract" value="6" />
			<item label="1.6_Stabilisatie_Overeenkomst" value="7" />
			<item label="1.7_Akte_van_verpanding" value="8" />
		...
		<nb-card-item>
		  <nb-item regular>
			<nb-input v-model="title" placeholder="Naam schuldeiser" />
		  </nb-item>
		</nb-card-item>
...
<script>
  ...
  export default {
	...
	clientData: async function () {
	  ...
	  try {
		let response = await fetch(`http://api.arsus.nl/consultant/client?id=${this.navigation.getParam('clientID')}`, {
		  method: 'GET',
		  headers: {
